...
dependencies {
    constraints {
        ...
        testImplementation("io.netty:netty-codec-http2:4.1.132.Final")
        testImplementation("io.netty:netty-codec-http:4.1.132.Final")
        testImplementation("io.netty:netty-codec:4.1.132.Final")
        testImplementation("io.netty:netty-common:4.1.132.Final")
        testImplementation("io.netty:netty-handler:4.1.132.Final")
        testImplementation("io.netty:netty-transport:4.1.132.Final")
    }
