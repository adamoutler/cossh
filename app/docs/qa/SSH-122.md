...
![AddEdit Telnet Banner](../../src/test/snapshots/images/com.adamoutler.ssh.ui.screens_AddEditProfileScreenScreenshotTest_telnetScreenWarningBanner.png)

Screenshot artifact of `ConnectionListScreen` showing both SSH and Telnet profiles with distinct icons:
![Connection List Telnet Icon](../../src/test/snapshots/images/com.adamoutler.ssh.ui.screens_ConnectionListScreenScreenshotTest_defaultScreen.png)

Screenshot artifact of `TerminalScreen` showing an active Telnet session with the header warning:
![Terminal Screen Telnet Overlay](../../src/test/snapshots/images/com.adamoutler.ssh.ui.components_TerminalScreenOverlayScreenshotTest_overlayButtonsVisibleTelnet.png)
