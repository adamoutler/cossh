...
![Renamed Group Default](../../src/test/snapshots/images/com.adamoutler.ssh.ui.screens_SettingsScreenScreenshotTest_defaultScreen.png)

Screenshot showing the text field updating to a new name (e.g. "My Custom Group"):
![Renamed Group Custom](../../src/test/snapshots/images/com.adamoutler.ssh.ui.screens_SettingsScreenScreenshotTest_screenWithRenamedGroup.png)
