...
- You MUST gather irrefutable proof of completion.
- Leverage agents like `evidence-collector` to assemble logs, test outputs, screenshots, or receipts.
- Record all proof in the `docs/qa/` folder (e.g., `docs/qa/SSH-1.md`).
...
- Your comment MUST explicitly reference the proof gathered in the `docs/qa/` directory.
   - Example: `mcp_kanban_complete_work(ticket_id="SSH-1", comment="Feature is completed. See proof in docs/qa/SSH-1.md.")`
